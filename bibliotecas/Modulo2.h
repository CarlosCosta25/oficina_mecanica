...
void menuAgendamento(Agendamento **agendamentos,Cliente *clientes, Veiculo *veiculos, Funcionario *funcionarios, Servico *servicos,OrdemServico *ordem_servicos);
...
int saveFinanceiroCSV(void ** filtro, int tamT, int tamCP, int CR); // Função que salva os dados financeiros em um arquivo CSV
void **filterIntervaloDatas(Transacao *transacoes, ContasPagar *contas_pagar, ContasReceber *contas_receber,
                            time_t dataI, time_t dataF,int * TamanhoT, int * TamanhoCP, int * TamanhoCR); // Função que filtra as transações por intervalo de datas
...
void filtrarFinanceiro(Transacao *transacoes, ContasPagar *contas_pagar, ContasReceber *contas_receber); // Função que filtra as transações financeiras
...
ContasReceber *filterContasReceberIntervaloDatas(ContasReceber *contas_receber, time_t dataInicio, time_t dataFim, int *Tamanho); // Função que filtra as contas a receber por intervalo de datas
...
void printContasReceber(ContasReceber * contas_receber, int tam); // Função que exibe as informações de todas as contas a receber
...
ContasPagar *filterContasPagarIntervaloDatas(ContasPagar *contas, time_t dataInicio, time_t dataFim, int *Tamanho); // Função que filtra as contas a pagar por intervalo de datas
// View contas a pagar
